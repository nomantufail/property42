...
use App\Repositories\Repositories\Sql\AssignFeatureRepository;

class AssignedFeatureJsonRepoProvider extends RepositoryProvider implements RepositoryProviderInterface
{
    public function repo()
    {
        return new AssignedFeaturesJsonRepository();
    }
}