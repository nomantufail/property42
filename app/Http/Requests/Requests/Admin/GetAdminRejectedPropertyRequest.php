...
use App\Http\Validators\Validators\AdminValidators\GetAdminRejectedPropertiesValidator;
...
use App\Transformers\Request\Admin\GetAdminRejectedPropertiesTransformer;


class GetAdminRejectedPropertyRequest extends Request implements RequestInterface{

    public $validator = null;
    private $properties = null;

    public function __construct(){
        parent::__construct(new GetAdminRejectedPropertiesTransformer($this->getOriginalRequest()));
        $this->validator = new GetAdminRejectedPropertiesValidator($this);
