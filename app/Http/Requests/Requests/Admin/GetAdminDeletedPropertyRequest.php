...
use App\Http\Validators\Validators\AdminValidators\GetAdminDeletedPropertiesValidator;
...
use App\Transformers\Request\Admin\GetAdminDeletedPropertiesTransformer;
use App\Transformers\Request\Admin\GetAdminPendingPropertiesTransformer;


class GetAdminDeletedPropertyRequest extends Request implements RequestInterface{

    public $validator = null;
    private $properties = null;

    public function __construct(){
        parent::__construct(new GetAdminDeletedPropertiesTransformer($this->getOriginalRequest()));
        $this->validator = new GetAdminDeletedPropertiesValidator($this);
