...
use App\Http\Validators\Validators\AdminValidators\GetAdminExpiredPropertiesValidator;
...
use App\Transformers\Request\Admin\GetAdminExpiredPropertiesTransformer;
use App\Transformers\Request\Admin\GetAdminPendingPropertiesTransformer;


class GetAdminExpiredPropertyRequest extends Request implements RequestInterface{

    public $validator = null;
    private $properties = null;

    public function __construct(){
        parent::__construct(new GetAdminExpiredPropertiesTransformer($this->getOriginalRequest()));
        $this->validator = new GetAdminExpiredPropertiesValidator($this);
