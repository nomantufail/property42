...
use App\Http\Validators\Validators\FeatureValidators\UpdateFeatureValidator;
use App\Transformers\Request\Feature\UpdateFeatureTransformer;

class UpdateFeatureRequest extends Request implements RequestInterface
{
    public $validator = null;
    public function __construct()
    {
        parent::__construct(new UpdateFeatureTransformer($this->getOriginalRequest()));
         $this->validator = new UpdateFeatureValidator($this);
    }
