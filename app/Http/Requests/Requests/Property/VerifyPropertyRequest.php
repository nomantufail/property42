...
class VerifyPropertyRequest extends Request implements RequestInterface{

    public $validator = null;
    private $properties = null;

    public function __construct(){
        parent::__construct(new VerifyPropertyTransformer($this->getOriginalRequest()));
        $this->validator = new VerifyPropertyValidator($this);
