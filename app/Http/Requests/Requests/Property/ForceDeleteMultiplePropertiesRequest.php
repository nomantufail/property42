...
use App\Http\Validators\Validators\PropertyValidators\ForceDeleteMultiplePropertiesValidator;
...
use App\Transformers\Request\Property\ForceDeleteMultiplePropertiesTransformer;

class ForceDeleteMultiplePropertiesRequest extends Request implements RequestInterface{

    public $validator = null;

    public function __construct(){
        parent::__construct(new ForceDeleteMultiplePropertiesTransformer($this->getOriginalRequest()));
        $this->validator = new ForceDeleteMultiplePropertiesValidator($this);
    }
