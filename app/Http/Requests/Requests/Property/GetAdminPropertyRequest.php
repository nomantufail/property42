...
class GetAdminPropertyRequest extends Request implements RequestInterface{

    public $validator = null;
    private $properties = null;

    public function __construct(){
        parent::__construct(new GetAdminPropertyTransformer($this->getOriginalRequest()));
        $this->validator = new GetAdminPropertyValidator($this);
