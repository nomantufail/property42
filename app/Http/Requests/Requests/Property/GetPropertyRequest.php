...
class GetPropertyRequest extends Request implements RequestInterface{

    public $validator = null;
    private $properties = null;

    public function __construct(){
        parent::__construct(new GetPropertyTransformer($this->getOriginalRequest()));
        $this->validator = new GetPropertyValidator($this);
