...
class RejectPropertyRequest extends Request implements RequestInterface{

    public $validator = null;
    private $properties = null;

    public function __construct(){
        parent::__construct(new RejectPropertyTransformer($this->getOriginalRequest()));
        $this->validator = new RejectPropertyValidator($this);
