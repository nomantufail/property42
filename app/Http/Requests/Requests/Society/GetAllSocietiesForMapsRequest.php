...
class GetAllSocietiesForMapsRequest extends Request implements RequestInterface{

    public $validator = null;
    public function __construct(){
        parent::__construct(new GetAllSocietiesForMapsTransformer($this->getOriginalRequest()));
        $this->validator =  new GetAllSocietiesForMapsValidator($this);
    }
