...
class GetSocietyFilesRequest extends Request implements RequestInterface{

    public $validator = null;
    public function __construct(){
        parent::__construct(new GetSocietyFilesTransformer($this->getOriginalRequest()));
        $this->validator =  new GetSocietyFilesValidator($this);
    }
